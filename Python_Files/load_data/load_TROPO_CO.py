...
#            ../../SQL_Scripts/make_TROPOMI_tables/make_CO_tables.sql " % 
...
cursor.execute('SELECT * FROM tropomi_CO_files_loaded;')
...
for file in reversed(sorted(os.listdir(SOURCE))):
    ...
    if file.endswith('.zip') and file_num > START_NUM and file_num <= END_NUM: 
        ...
        if (file not in files_loaded):
            ...
            cursor.execute("INSERT INTO tropomi_CO_files_loaded VALUES (\'%s\');" % file) 
